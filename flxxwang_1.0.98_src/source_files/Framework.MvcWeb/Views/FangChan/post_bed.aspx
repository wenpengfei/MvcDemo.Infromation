...
<tr> 
    ...
    <td> 
        ...
        <label> <input onclick="tojump(this)" id="HireType_0" f="{0}" class="base" type="radio" name="HireType" value='2'/>单间出租</label>  &nbsp;&nbsp;&nbsp;&nbsp;
        <label> <input onclick="tojump(this)" id="HireType_1" f="{0}" class="base" type="radio" name="HireType" value='3' checked="checked" />床位</label>  

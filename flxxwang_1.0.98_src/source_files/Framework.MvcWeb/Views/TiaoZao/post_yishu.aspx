...
<tr> 
    ...
    <td class="checkpb">  
        <label> <input class="base" onclick="change(this)" type="radio" name="type" id="type_0" f="{0}" value='0' checked /><span>转让</span></label>&nbsp;&nbsp;&nbsp;&nbsp;  
        <label> <input class="base" onclick="change(this)" type="radio" name="type" id="type_1" f="{0}" value='1'  /><span>求购</span></label>&nbsp;&nbsp;&nbsp;&nbsp;  
...
<tr> 
    ...
    <td> 
        <select name="ObjectType" id="ObjectType" f="{0}"> 
            ...
            <%
                foreach (var item in SaleArt.Singleton.ObjectTypeCollection)
                {
                    %>
...
<tr id="tt" style="display: none" class="pb"> 
    ...
    <td> 
        <ul class="tag3" id="tagul"> 
            <%--<li><input name="Tag" id="Tag_0" type="checkbox" value="469"  />十字绣</li>
            <li><input name="Tag" id="Tag_1" type="checkbox" value="1323"  />珠宝首饰</li>
            <li><input name="Tag" id="Tag_2" type="checkbox" value="1325"  />玉器</li>
            <li><input name="Tag" id="Tag_3" type="checkbox" value="1383"  />贵金属首饰</li>
            <li><input name="Tag" id="Tag_4" type="checkbox" value="1744"  />书法</li>
            <li><input name="Tag" id="Tag_5" type="checkbox" value="1745"  />山水画</li>
            <li><input name="Tag" id="Tag_6" type="checkbox" value="1747"  />人物画</li>
            <li><input name="Tag" id="Tag_7" type="checkbox" value="1748"  />花鸟画</li>
            <li><input name="Tag" id="Tag_8" type="checkbox" value="1750"  />装饰画</li>
            <li><input name="Tag" id="Tag_9" type="checkbox" value="1930"  />奥运纪念品</li>
            <li><input name="Tag" id="Tag_10" type="checkbox" value="1932"  />世博会纪念品</li>
            <li><input name="Tag" id="Tag_11" type="checkbox" value="3512"  />邮票邮品</li>
            <li><input name="Tag" id="Tag_12" type="checkbox" value="3513"  />钱币</li>
            <li><input name="Tag" id="Tag_13" type="checkbox" value="3514"  />雕品</li>--%>
            <%
                foreach (var item in SaleArt.Singleton.TagCollection)
                {
                    %>
...
<tr> 
    ...
    <td> <input class="text3 gray" type="text" id="MinPrice" f="{0}元" name="MinPrice" value='面议'  Except='面议'  maxLength=6/> 元<span id="MinPrice_Tip"></span> </td> 
</tr>
</asp:Content>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#ObjectType').get(0).onchange = function () {
            //            $.c.sale.gettag(47, 2996, 'ObjectType', 0, "tagul", "tt");

...
<tr> 
    <td class="t"> 所在小区： </td> 
    <td> <input class="text2" type="text" id="xiaoqu" name="quanjuxiaoqu" value=''  Except='null'  maxLength=30/> 
...
<tr> 
    ...
    <td> 
        <select name="ObjectType" id="ObjectType" f="{0}"> 
            ...
            <option value='2' > 手机上网卡</option>  
            <option value='3' > 手机业务</option>--%>
            <%
                foreach (var item in SaleCommunication.Singleton.ObjectTypeCollection)
                {
                    %>
...
<script type="text/javascript">
    function post() {
        var sale = new SaleCommunication();

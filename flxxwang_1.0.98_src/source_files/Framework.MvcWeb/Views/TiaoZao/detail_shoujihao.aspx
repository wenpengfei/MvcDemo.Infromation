...
<%
    ...
    var sale = ViewTag.Info as SaleMobileNumber;
%>
<ul class="info">
    <%
    ...
    %>
    <li><i class="z">手机号：</i><%=sale.Number %></li>
    <li><i class="z">价格：</i>
        <%
            if (sale.Price == 0)
            {
    ...
    <%
        if (!string.IsNullOrWhiteSpace(sale.Character))
        {
            %>
            <li><i class="z">号码特征：</i><%=sale.Character %></li>
            <%
        }
    %>
    <li><i class="z">区域：</i>

...
<script type="text/javascript">
    ...
    function ResizeFrame(iframe) {
        try {
            ...
            iframe.style.height = Math.max(height, 460) + "px";
        }
        catch (ex) { }
    }
    
</script>
<iframe id="ContainerFrame" name="ContainerFrame" onreadystatechange="stateChangeIE(this)" onload="ResizeFrame(this)" src="<%=Url.Action("favoriteresumelist")%>" scrolling="no" class="userscore" frameborder="0" marginwidth="0" marginheight="0" ></iframe>
<script>
    var menuid = "yixiazaijianli";
</script>

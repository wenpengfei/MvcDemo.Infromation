...
<iframe id="ContainerFrame" name="ContainerFrame" onreadystatechange="stateChangeIE(this)" onload="ResizeFrame(this)" src="<%=Url.Action("invitesendedlist")%>" scrolling="no" class="userscore" frameborder="0" marginwidth="0" marginheight="0" ></iframe>
<script>
    var menuid = "fasongmianshi";
</script>

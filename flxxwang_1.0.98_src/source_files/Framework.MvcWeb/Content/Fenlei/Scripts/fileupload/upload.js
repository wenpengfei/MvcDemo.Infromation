...
$info.Uploader = {
    ...
    upload: function () {
        ...
        if (a.val().length > 0) {
            ...
            if (objframe.attr('src') == '/Content/Fenlei/fileupload/SkinPart/submit.htm') {
                ...
                objframe.attr("src", "/Content/Fenlei/fileupload/SkinPart/submit.htm");
            }
        }
    },
    // 获取一个可用的iframe窗口
    ...
    startUpload: function (iframeName, pos) {
        ...
        //                f.action = "/upload";
        f.action = "/Content/Fenlei/fileupload/upload.aspx";
        f.target = iframeName;
        f.submit();

    ...
    __resume._post("DataSelect", [userid, resumeType], function (data, textStatus, jqXHR) {
        if (data != null) {
            ...
            if (initPart == null || initPart == resumePart.basic) {
                ...
                $("#ulSInfo li:eq(1)").html($("#ulSInfo li:eq(1) i")[0].outerHTML + resume.Phone); //.append(resume.Phone);
                $("#ulSInfo li:eq(2)").html($("#ulSInfo li:eq(2) i")[0].outerHTML + resume.Email); // .append(resume.Email);
                $("#ulSInfo li:eq(3)").html($("#ulSInfo li:eq(3) i")[0].outerHTML + resume.NowCity.ShortName); //.append(resume.NowCity.Name);
                $("#ulSInfo li:eq(4)").html($("#ulSInfo li:eq(4) i")[0].outerHTML + resume.EducationName); // .append(resume.Education);
                //工作经验
...
function save(savePart,callback) {
    if (resume.Id < 0) {
        resume.DateCreated = new Date().toJson(true);
        resume.DateModified = resume.DateCreated;
...
//    }
    ...
    save(resumePart.basic,callback);
...
function dyniframesize(iframename) {
    var iframeid = parent.document.getElementById(iframename); //iframe id

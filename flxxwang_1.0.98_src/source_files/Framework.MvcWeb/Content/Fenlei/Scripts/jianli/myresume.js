...
function subform1(callback) {
    ...
    xmlText += "<sendinfo>";
    xmlText += "<operate>resumeinfo</operate>";
...
function subformExpr(callback) {
    ...
    var edpid = $("#hidSPC3").val();
    var epositionname = $("#txtPositionName").val();
    var esalary = $("#positionSalary").val();
    ...
    if (xmlHttp.readyState == 4) {
        if (xmlHttp.status == 200) {
            if (xmlHttp.responseText.indexOf("error:") != -1) {
                ...
                str += $("#spEduStatYear .txtyear").val() + " 年 " + $("#spEduStatMonth .txtmonth").val() + " 月— " + $("#spEduEndYear .txtyear").val() + " 年 " + $("#spEduEndMonth .txtmonth").val() + " 月 <span>|</span> " + $("#txtSchool").val() + " <span>|</span> " + $("#txtProfessional").val() + "</li>";
...
function editExpe(id) {
    ...
    $("#hidSPC3").val(hidVal[3]); $("#hidPC3").val(hidVal[1]);
    $("#hidSPCN3").val(hidVal[4]); $("#hidPCN3").val(hidVal[2]); $("#selPosCate3").find("span").text(hidVal[4]); $("#selPosCate3").find("span").removeClass("c99");
    $("#txtPositionName").val(hidVal[5]);
    $("#positionSalary").attr("value", hidVal[6]);
    $("#spPosStatYear .txtyear").val(hidVal[7]);
    $("#spPosStatMonth .txtmonth").val(hidVal[8]);
    $("#spPosEndYear .txtyear").val(hidVal[9]);
    $("#spPosEndMonth .txtmonth").val(hidVal[10]);
    $("#txtPerformance").val(hidVal[11]);
    if (hidVal[9] == "至今") {
        $("#spEnd").hide();
    } else {
        $("#spEnd").show();
...
//    src.src = "http://010.zp.com/ajax/getdispposcatelist/?n=" + n + "&pcid=" + id + "&dp=" + dp + "&t=0&name=" + encodeURIComponent(name);
...
$(document).ready(function() {
    ...
    $("#txtLiveArea").click(function() { if ($("#divLiveArea").html() == "") { showSecondLive(1, '北京'); } else { $("#divLiveArea").show(); $("#divLiveCity").hide(); $("#divLiveName").hide(); } });
    ...
    if (xmlHttp.readyState == 4) {
        if (xmlHttp.status == 200) {
            if (xmlHttp.responseText.indexOf("error:") != -1) {
                ...
                str += $("#spEduStatYear2 .txtyear").val() + " 年 " + $("#spEduStatMonth2 .txtmonth").val() + " 月— " + $("#spEduEndYear2 .txtyear").val() + " 年 " + $("#spEduEndMonth2 .txtmonth").val() + " 月 <span>|</span> " + $("#txtSchool2").val() + " <span>|</span> " + $("#txtProfessional2").val() + "</li>";
    ...
    if (xmlHttp.readyState == 4) {
        if (xmlHttp.status == 200) {
            if (xmlHttp.responseText.indexOf("error:") != -1) {
                ...
                var id = xmlHttp.responseText;
                var salary = $("#positionSalary2").val() > 1 ? $("#positionSalary2").find("option:selected").text() + " 元/月" : $("#positionSalary2").find("option:selected").text();
                var endDate = $("#spPosEndYear2 .txtyear").val() == "至今" ? "至今" : $("#spPosEndYear2 .txtyear").val() + " 年 " + $("#spPosEndMonth2 .txtmonth").val() + " 月";
                var str = "<input type=\"hidden\" value=\"" + $("#txtCompName2").val() + "'" + $("#hidPC2").val() + "'" + $("#hidPCN2").val() + "'" + $("#hidSPC2").val() + "'" + $("#hidSPCN2").val() + "'" + $("#txtPositionName2").val() + "'" + $("#positionSalary2").val() + "'" + $("#spPosStatYear2 .txtyear").val() + "'" + $("#spPosStatMonth2 .txtmonth").val() + "'" + $("#spPosEndYear2 .txtyear").val() + "'" + $("#spPosEndMonth2 .txtmonth").val() + "'" + repLaceData($("#txtPerformance2").val()) + "\" id=\"hidExpe2Val" + id + "\">";
                str += "<li>";
                ...
                str += $("#spPosStatYear2 .txtyear").val() + " 年 " + $("#spPosStatMonth2 .txtmonth").val() + " 月— " + endDate + " <span>|</span> " + $("#txtCompName2").val() + " <span>|</span> " + $("#txtPositionName2").val() + " <span>|</span> " + salary + "</li><li>" + repLaceData($("#txtPerformance2").val()).replace(/\n/g, "<br>").replace(/\r\n/g, "<br>") + "</li>";
...
function subformTempExpr(callback) {
    ...
    var edpid = $("#hidSPC2").val();
    var epositionname = $("#txtPositionName2").val();
    var esalary = $("#positionSalary2").val();
...
function editTempExpe(id) {
    ...
    $("#hidSPC2").val(hidVal[3]); $("#hidPC2").val(hidVal[1]);
    $("#hidSPCN2").val(hidVal[4]); $("#hidPCN2").val(hidVal[2]); $("#selPosCate2").find("span").text(hidVal[4]); $("#selPosCate2").find("span").removeClass("c99");
    $("#txtPositionName2").val(hidVal[5]);
    $("#positionSalary2").attr("value", hidVal[6]);
    $("#spPosStatYear2 .txtyear").val(hidVal[7]);
    $("#spPosStatMonth2 .txtmonth").val(hidVal[8]);
    $("#spPosEndYear2 .txtyear").val(hidVal[9]);
    $("#spPosEndMonth2 .txtmonth").val(hidVal[10]);
    $("#txtPerformance2").val(hidVal[11]);
    if (hidVal[9] == "至今") {
        $("#spEnd2").hide();
    } else {
        $("#spEnd2").show();

...
namespace Infomation.Core
{
    ...
    /// 床位出租.
    /// </summary>
    [Table(Name = "Info_HouseBed")]
    public class HouseBed : HouseBase<HouseBed>
    {
        public string Title
        {
            get;
        ...
        public override List<ObjectType> ObjectTypeCollection
        {
            get
            {
                if (_objectTypeCollection == null)
                {
                    ...
                    var category = houseCategory.Children.FirstOrDefault(item => item.Singleton == HouseBed.Singleton);
                    if (category != null)
                    {
        ...
        protected override DataAccess<HouseBed, int> GetProvider()
        {
            return new HouseBedDataAccess();
        }

...
{
    public class HouseShopDataAccess : DataAccess<HouseShop, int>
    {
        //public override HouseShop Insert(HouseShop instance)
        //{
        //    HouseShop house = instance as HouseShop;

        //    string sql = "INSERT INTO " + TableName + " (Type,Title,District1,District2,ObjectType,Management,Price,Price2,PriceTransfer,PriceUnit,Area,Area2,[Content],IsBiz,ContactPerson,Phone,Pictures,UserId,CityId,RegionId,CircleId,Source)" +
        //                                "VALUES (@Type,@Title,@District1,@District2,@ObjectType,@Management,@Price,@Price2,@PriceTransfer,@PriceUnit,@Area,@Area2,@Content,@IsBiz,@ContactPerson,@Phone,@Pictures,@UserId,@CityId,@RegionId,@CircleId,@Source)";
        ...
        //    db.AddInParameter(cmd, "@Management", DbType.String, house.Management);
        ...
        //    db.AddInParameter(cmd, "@Area2", DbType.Int16, house.Area2);
        ...
        public override List<HouseShop> Insert(List<HouseShop> instances)
        {
            ...
            {
                sql += ";INSERT INTO " + TableName + " (Type,Title,District1,District2,ObjectType,Management,Price,Price2,PriceTransfer,PriceUnit,Area,Area2,[Content],IsBiz,ContactPerson,Phone,Pictures,UserId,CityId,RegionId,CircleId,Source,Sequence,TId)" +
                                            "VALUES (@Type" + i + ",@Title" + i + ",@District1_" + i + ",@District2_" + i + ",@ObjectType" + i + ",@Management" + i + ",@Price" + i + ",@Price2_" + i + ",@PriceTransfer" + i + ",@PriceUnit" + i + ",@Area" + i + ",@Area2_" + i + ",@Content" + i + ",@IsBiz" + i + ",@ContactPerson" + i + ",@Phone" + i + ",@Pictures" + i + ",@UserId" + i + ",@CityId" + i + ",@RegionId" + i + ",@CircleId" + i + ",@Source" + i + ",@Sequence"+i+",@TId"+i+")";
                sql += " ;SELECT SCOPE_IDENTITY() as newIDValue ";
            }
            sql = sql.Substring(1);
            ...
            for (var i = 0; i < instances.Count(); i++)
            {
                ...
                db.AddInParameter(cmd, "@Management" + i, DbType.String, house.Management);
                ...
                db.AddInParameter(cmd, "@Area2_" + i, DbType.Int16, house.Area2);
